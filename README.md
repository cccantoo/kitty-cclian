...
- 📝 **备忘录（v2）**：待办清单（可勾选+进度）、6 色贴纸、置顶、标签筛选、全文搜索、归档、回收站（可恢复/彻底删除）、排序、一键复制
...
- ✅ **v0.3.5** — 多账本：新建/切换/重命名/删除/默认账本，交易报表预算账户随账本隔离；修复支出/收入/转账切换高亮 bug
- ✅ **v0.3.6（本次）** — 备忘录 v2：待办清单 / 颜色贴纸 / 标签筛选 / 排序 / 置顶 / 归档 / 回收站 / 复制
